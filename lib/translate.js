...
// Traduce titulo, extracto y contenido a todos los idiomas en paralelo.
// Devuelve { gl: { titulo, extracto, contenido }, en: {...}, ... }
export async function translatePost(titulo, extracto, contenido) {
  const results = await Promise.all(
    ALL_TARGET_LANGS.map(async (lang) => {
