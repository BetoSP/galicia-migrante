    ...
    <div style={{
      ...
      <div style={{
        ...
        <h1 style={{
          ...
          Investigación de Raíces Gallegas
        </h1>
        <p style={{
          fontSize: '16px',
          ...
          Accede a bases de datos de barcos de inmigrantes, solicitudes consulares y registros parroquiales de Galicia. Esta sección estará disponible próximamente.
        </p>
        <Link href="/" style={{
